...
namespace DxR
{
    ...
    public class Mark : MonoBehaviour
    {
        ...
        protected virtual string GetValueForChannelEncoding(ChannelEncoding channelEncoding, int markIndex)
        {
            ...
            return channelEncoding.scale.ApplyScale(datum[channelEncoding.field]);
        }
        ...
        #region New brushing and linking features
        ...
        public void Unhighlight()
        {
            ...
            {
                IsHighlighted = false;
                myRenderer.material.color = baseColour;
            }
        }
        ...
        public void Filter()
        {
            if (!IsFiltered)
            {
                ...
                if (IsHighlighted)
                {
                    ...
                    BrushingAndLinking.BrushingManager.Instance.MarkFiltered(this);
                    BrushingAndLinking.HighlightManager.Instance.UnhighlightProductByName(GameObjectName);
                }
        ...
        #endregion New brushing and linking features
    }
}
