...
namespace BrushingAndLinking
{
    ...
    public class BrushingManager : MonoBehaviour
    {
        ...
        public List<Mark> BrushedMarks = new ();
        // The list of names of Products that are brushed
        public List<string> BrushedNames = new ();
        ...
        public Color AdditiveBrushColour = new (1, 1, 0, 0.3f);
        public Color SubtractiveBrushColour = new (1, 0, 0, 0.3f);
            ...
            switch (BrushMode)
            {
                case BrushMode.Sphere:
                    ...
                    if (brushSphere == null)
                    {
                        ...
                        brushSphere.transform.localScale = new Vector3(BrushRadius, BrushRadius, BrushRadius);
                    }
                    else
                    {
                        PositionBrushSphere();
        ...
        private void GetAndHighlightBrushedMarks()
        {
                ...
                case BrushMode.Sphere:
                    {
                        ...
                        newBrushedMarks = Physics.OverlapSphere(BrushPoint.position, BrushRadius)
                            .Where(go => go.CompareTag("DxRMark"))
                ...
                case BrushMode.Box:
                    {
                        ...
                        newBrushedMarks = Physics.OverlapBox(brushBox.transform.position, new Vector3(brushBox.transform.lossyScale.x / 2f, brushBox.transform.lossyScale.y / 2f, 0.05f), brushBox.transform.rotation)
                            .Where(col => col.CompareTag("DxRMark"))
            ...
            BrushedNames = BrushedMarks.Select(mark => mark.GameObjectName).ToList();
        ...
        private void PositionBrushBox()
        {
            ...
            Vector3 size = new Vector3(right - left, top - bottom, 0.001f);
